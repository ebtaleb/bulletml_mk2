pub mod bml {
    ...
    impl BulletMLNode {
        pub fn new() -> BulletMLNode {
            BulletMLNode { name : Name::None, label : None, type_ : Type::None, ref_id : -1, val : -1.0 }
        }

        pub fn new_cell(n : &str) -> RefCell<BulletMLNode> {
            RefCell::new(BulletMLNode { name : string2name(n), label : None, type_ : Type::None, ref_id : -1, val : -1.0 })
        }
